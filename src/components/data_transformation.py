...
class DataTransformation:
    def __init__(self):
        ...
        def get_transformer_object(self):
            '''
            This function is responsible for the data trasformation of the ingested dataset
            '''
            try:
    ...
    def inititate_data_trasformation(self,train_path,test_path):
        ...
        try:
            ...
            input_feature_test_df=df.drop(columns=[target_column_name],axis=1)
            ...
            logging.info(f"Saved preprosessing objects.")

            # saving the pikle file
            save_object(
